...
module.exports.services.Alterdot = require('./lib/services/alterdotd');
...
module.exports.cli.alterdot = require('./lib/cli/alterdot');
module.exports.cli.alterdotd = require('./lib/cli/alterdotd');

module.exports.lib = require('alterdot-lib');
